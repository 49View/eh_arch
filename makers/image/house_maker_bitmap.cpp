...
//        gatherGeneralTextInformations( house.get(), g_sourceImages, house->sourceData );
        ...
        house->reRoot(house->sourceData.rescaleFactor, ArchRescaleSpace::FloorplanScaling, V3f::ZERO, Quaternion{});
...
//        gatherGeneralTextInformations( house.get(), g_sourceImages, house->sourceData );
    ...
    void makeFromWalls( HouseBSData *house ) {
        ...
        house->reRoot( 1.0f / house->sourceData.rescaleFactor, ArchRescaleSpace::FloorplanScaling, V3f::ZERO, Quaternion{});
